...
#
# Generated by Vivado on Wed Apr 03 17:52:00 CEST 2019
...
# Script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/deki/Downloads/hsos/gtwizard_0_ex/gtwizard_0_ex.cache/compile_simlib/modelsim"
  fi
